...
public class ComingooAndYouActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        ...
        switch (selectedScreen) {
            case 0:
                AnimateConstraint.fadeIn(ComingooAndYouActivity.this, parametreLayout, 500, 10);
                break;
            case 1:
                AnimateConstraint.fadeIn(ComingooAndYouActivity.this, profileLayout, 500, 10);
                break;
            case 2:
                break;
            case 3:
                AnimateConstraint.fadeIn(ComingooAndYouActivity.this, changePasswordLayout, 500, 10);
                break;
            case 4:
                break;
            case 5:
                AnimateConstraint.fadeIn(ComingooAndYouActivity.this, portFeuilleLayout, 500, 10);
                break;
            case 6:
                AnimateConstraint.fadeIn(ComingooAndYouActivity.this, tarifsLayout, 500, 10);
                break;
        }
    ...
    public void updateViews() {
        ...
        context = LocalHelper.setLocale(ComingooAndYouActivity.this, language);
    ...
    private void updatePassword(final String oldPassword, final String newPassword, final String confirmPassword) {
        ...
        if (newPassword.length() != 0 && confirmPassword.length() != 0 && oldPassword.length() != 0) {
            if (newPassword.length() < 8) {
                Toast.makeText(ComingooAndYouActivity.this, "Mot de passe doit avoir 8 lettres.", Toast.LENGTH_SHORT).show();
                                                ...
                                                FirebaseAuth.getInstance().getCurrentUser().updatePassword(newPassword).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(ComingooAndYouActivity.this, "Error!!! ", Toast.LENGTH_SHORT).show();
                                                            changePassBtn.setVisibility(View.VISIBLE);
                                                            findViewById(R.id.progressBar).setVisibility(View.GONE);
                                                        }
                                                    }
